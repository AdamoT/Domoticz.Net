...
namespace DomoticzNet.Service
{
	public partial class DomoticzService
	{
        ...
        /// <summary>
        ///     Some lights have 100 dim levels (like zwave and others), other hardware (kaku/lightwaverf) have other ranges like
        ///     16/32
		...
		public Task SetThermostatSetPoint(int idx, float setPoint)
		{
			...
			query[_QueryIdx] = idx.ToString(CultureInfo.InvariantCulture);
			query["setpoint"] = setPoint.ToString(CultureInfo.InvariantCulture);
